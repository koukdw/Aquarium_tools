...
|              |                  |                    | Type 1 is a `string`, `R0` contains an `index` into a stringArray or a stringVariable array then `GET_STRING(index)` |
